...
import (
	...
	clusterclientset "github.com/alita/alita/pkg/client/clientset/versioned"
...
func Run(opt *options.ServerOption) error {
	...
	// Create clients.
	kubeClientSet, clusterClientSet, err := createClientSets(kcfg)
	if err != nil {
		return err
	}
...
func createClientSets(config *restclientset.Config) (kubeclientset.Interface, clusterclientset.Interface, error) {
	...
	return kubeClientSet, clusterClientSet, nil
}
